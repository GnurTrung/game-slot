...
const app = new PIXI.Application({ background: "#1099bb", width: 420 });
...
function onAssetsLoaded() {
  ...
  reelContainer.x = Math.round(app.screen.width - REEL_WIDTH * 2.8);
  ...
  // Add header text
  const headerText = new PIXI.Text("MONSTER SLOTS!", style);
